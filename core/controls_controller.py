...
from core.controls.controls_acquisition import (
    ...
    get_frequency_mhz,
    _is_pico_mode_available,
    update_pico_mode_toggle,
...
class ControlsController:
    ...
    def _is_pico_mode_available(app, frequency_mhz=None):
        return _is_pico_mode_available(app, frequency_mhz)

    @staticmethod
    def update_pico_mode_toggle(app, frequency_mhz=None):
        update_pico_mode_toggle(app, frequency_mhz)
    ...
    def get_selected_channels_from_settings(app):
        get_selected_channels_from_settings(app)
