...
============================================================
Data initialization helpers for intensity and decay curve plots + plots generation orchestration

Provides plain functions that retrieve cached plot data
or generate sensible numpy defaults based on application state or generate plots.
"""
