...
plot_builders.py
============================================================
UI widget construction for all plot types in the spectroscopy base software.

Provides plain functions that build and wire up pyqtgraph
    ...
    if app.acquire_read_mode == "acquire":
        ...
        if app.tab_selected == s.TAB_SPECTROSCOPY:
            ...
            curve_widget.setTitle(
                f"{get_channel_name(channel, metadata_channel_names)} decay"
            )
