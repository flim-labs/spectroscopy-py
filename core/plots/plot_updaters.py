...
def clear_plots(app, deep_clear=True):
    ...
    LaserBlood difference: also clears app.intensity_plot_widgets, which
    holds direct PlotWidget references populated by create_intensity_section.
