...
---------------------------
core.acquisition.acquisition_lifecycle  — full start/stop lifecycle
                                          (Laserblood: metadata validation,
                                           no pico_mode kwarg override,
                                           set_FPGA_firmware / set_average_CPS /
                                           set_average_SBR after stop)
core.acquisition.acquisition_reference  — reference file validation (shared)
core.acquisition.acquisition_data       — real-time data processing                                      
"""
