...
- Pile-up threshold and SBR display controls
- Fitting controls (deconvolution toggle)
- Phasor controls (quantize, resolution)
- Calibration controls (calibration type, TAU, harmonics)
- Harmonic selector
...
def _create_harmonic_control(app, layout):
    """
    Creates control for the harmonic display selector.
...
def create_control_inputs(app):
    ...
    _create_harmonic_control(app, controls_row)
