...
# ============================================================================
# STEP 1: Read laserblood metadata
# ============================================================================
print("=" * 70)
print("LASERBLOOD METADATA")
print("=" * 70)
...
# ============================================================================
# STEP 2: Read spectroscopy metadata
# ============================================================================
print("=" * 70)
...
# ============================================================================
# STEP 3: Read fitting results from JSON
# ============================================================================
print("=" * 70)
...
for i, result in enumerate(fitting_results):
    ...
    axes[row, col].set_title(f"Channel {channel + 1} {deconv_status}", color="white")

    # Create combined legend with all handles
    axes[row, col].legend(
        handles, labels, facecolor="grey", edgecolor="white", loc="upper right"
    )
