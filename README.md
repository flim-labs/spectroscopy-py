...
To directly test the application, skipping the prerequisites and installation requirements you can download an installer at this [link](https://github.com/flim-labs/spectroscopy-py/releases/tag/v2.5.1) (_Note: you still need to have the FLIM LABS acquisition card_).
...
- [Spectroscopy GUI guide](./docs/v2.5.1/index.md)
