...
<div align="center">
  <h1>Spectroscopy Laserblood v3.2</h1>
</div>
<div align="center">
  ...
  <ol>
    ...
    <li><a href="#fitting-mode">Fitting Mode</a></li>
     ...
     <li><a href="#connection-type">Connection Type</a></li>
      ...
      <li><a href="#decay-calculation-mode">Decay calculation mode</a></li>
...
Welcome to [FLIM LABS Spectroscopy Laserblood](https://github.com/flim-labs/spectroscopy-py) _v3.2_ usage guide. In this documentation section, you will find all the necessary information for the proper use of the application's **graphical user interface** (GUI).
...
<div align="center">
    <img src="../assets/images/spectroscopy-laserblood-settings-gui-v3.2.png" alt="Spectroscopy Laserblood Settings bar" width="100%">
</div>
...
#### Decay calculation mode

This control allows users to select how the decay curve is computed and updated during acquisition. Two modes are available: **Cumulative**, where photon counts are accumulated over time (default behavior), and **Refreshed**, where the histogram is recomputed at each time-span interval without accumulating previous counts.
...
| `decay_calc_mode`    | number      | Defines how  decay curve is calculated and displayed (cumulating counts over time or recomputing counts at each time-span interval)                                                                                  | 0  (Cumulated)       | 0 = Cumulated; 1 = Refreshed   
