...
Welcome to [FLIM LABS Spectroscopy](https://github.com/flim-labs/spectroscopy-py) _v2.6_ usage guide. In this documentation section, you will find all the necessary information for the proper use of the application's **graphical user interface** (GUI).
